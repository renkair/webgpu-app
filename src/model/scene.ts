...
export class Scene{
    ...
    constructor() {
        ...
        this.make_triangles();
        this.make_quads();
        this.statue = new Statue([0, 0, 0.6], [0, 0, 0]);
    ...
    move_player(forwards_amount: number, right_amount: number){
        vec3.scaleAndAdd(
            this.player.position, this.player.position, this.player.forwards, forwards_amount
        );
        vec3.scaleAndAdd(
            this.player.position, this.player.position, this.player.right, right_amount
        );
    }
